# Test world path RNN performance.
...
echo numNonterminals,nonTerminalProductions,productionRightHandSideLength,numPaths,numPathExpansions,train_correct_paths,train_total_paths,train_prediction_errors,train_total_predictions,train_error_pct,test_correct_paths,test_total_paths,test_prediction_errors,test_total_predictions,test_error_pct > world_path_rnn_test_results.csv
    ...
    do
      ...
      do
        ...
        do
           ...
           python world_path_rnn.py
           echo ${numNonterminals},${nonTerminalProductions},${productionRightHandSideLength},${numPaths},${numPathExpansions},$(cat world_path_rnn_results.json | cut -d'"' -f4,8,12,16,20,24,28,32,36,40 | sed 's/"/,/g') >> world_path_rnn_test_results.csv
        done
      done
    done
  done
