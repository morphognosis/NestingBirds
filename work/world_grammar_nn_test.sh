# Test world grammar NN performance.
    ...
    do
      ...
      do
        ...
        do
           ...
           ./world_grammar_nn.sh
           echo ${numNonterminals},${nonTerminalProductions},${productionRightHandSideLength},${numPaths},${numPathExpansions},$(cat world_grammar_nn_results.json | cut -d'"' -f4,8,12,16,20,24,28,32,36,40 | sed 's/"/,/g') >> world_grammar_nn_test_results.csv
        done
      done
    done
  done
