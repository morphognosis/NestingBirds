...
// Food.
int     FOOD_DURATION = 200;
int     INITIAL_FOOD = FOOD_DURATION;
bool RANDOMIZE_FOOD_LEVEL = false;

// Needs.
Mona::NEED MOUSE_NEED = 75.0;
Mona::NEED FOOD_NEED = 100.0;
Mona::NEED FEMALE_FOOD_NEED = 50.0;
Mona::NEED STONE_NEED = 7.5;
Mona::NEED FEMALE_STONE_NEED = 10.0;
Mona::NEED ATTEND_FEMALE_NEED = 5.0;
